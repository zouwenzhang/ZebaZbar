...
import com.zeba.zbar.view.CameraScanAnalysis;
...
public class ZBarScanView extends RelativeLayout implements Callback {
	...
	public void surfaceChanged(SurfaceHolder holder, int format, int width,
		...
		CameraManager.get().autoFocus(mFocusCallback);
	}
	...
	private void initCamera(SurfaceHolder surfaceHolder) {
		try {
			...
			cropHeight = (mScanRect.bottom - mScanRect.top) * height
					/ getMeasuredHeight();
			mPreviewCallback.setCorp(x,y,cropWidth,cropHeight);
			CameraManager.get().startPreview(mPreviewCallback);
			/**************************************************************/
	...
	public void setScanResultListener(ZBarScanListener listener) {
		mPreviewCallback.setScanCallback(listener);
	}
}